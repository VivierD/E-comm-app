    ...
    <div className="global-container">
        ...
        <ul className="cart-list">
            {storeState.cart.map((item) => (
                <li key={item.id}>
                    <img src={process.env.PUBLIC_URL + `/images/${item.img}.png`} alt="Image produit"/>
                    <div className="bloc-cart-infos">
                        ...
                        <input onChange={e => handleChange(e, item.id)} id="quantityInput" type="number" value={item.quantity} />
                    </div>
                </li>
            ))}
        </ul>
